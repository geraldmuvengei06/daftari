  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-2 sm:hidden">
        {Array.from({ length: rows }).map((_, r) => (
          <div key={r} className="rounded-xl border p-3 space-y-2">
  ...
  return (
    <div className={cn("grid gap-4", count > 2 ? "sm:grid-cols-2" : "sm:grid-cols-2")}>
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="relative flex items-center gap-4 overflow-hidden rounded-xl bg-muted/40 p-4"
        >
      ...
      <div className="rounded-xl border p-6 space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="flex items-start gap-3">
            <Bone className="size-4 mt-0.5 rounded" />
            <div className="space-y-1.5">
